...
import { T as Registry, V as HasRegistry } from '../action-DSIx65PQ.js';
...
export { ATTR_PREFIX, SPAN_TYPE_ATTR, appendSpan, runInNewSpan, setCustomMetadataAttribute, setCustomMetadataAttributes, spanMetadataAlsKey, toDisplayPath };
